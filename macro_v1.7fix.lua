...
local function mkBox(p,x,y,w,h,ph)
    ...
    b.TextColor3=Color3.new(1,1,1) b.Font=Enum.Font.Gotham b.TextSize=9
    ...
    b.Focused:Connect(function() TweenService:Create(s,TweenInfo.new(0.18),{Color=Color3.fromRGB(88,140,255)}):Play() end)
    b.FocusLost:Connect(function() TweenService:Create(s,TweenInfo.new(0.18),{Color=Color3.fromRGB(55,55,72)}):Play() end)
    local dl=Instance.new("TextLabel",b)
    dl.Size=UDim2.new(1,-8,1,0) dl.Position=UDim2.new(0,6,0,0)
    dl.BackgroundTransparency=1 dl.TextColor3=Color3.new(1,1,1)
...
-- lang bar inside how
local howLangBar=Instance.new("Frame",howPage)
howLangBar.Size=UDim2.new(1,-16,0,32) howLangBar.Position=UDim2.new(0,8,0,50)
howLangBar.BackgroundColor3=Color3.fromRGB(28,28,38) howLangBar.BorderSizePixel=0
Instance.new("UICorner",howLangBar).CornerRadius=UDim.new(0,9)
local lbw=math.floor((FW-32)/3)
local hlEN=mkBtn(howLangBar,"EN",4,4,lbw-4,24,BLUE)
local hlTH=mkBtn(howLangBar,"TH",lbw+4,4,lbw-4,24,BLUE)
local hlVN=mkBtn(howLangBar,"VN",lbw*2+4,4,lbw-4,24,BLUE)
hlEN.TextSize=11 hlTH.TextSize=11 hlVN.TextSize=11

-- scroll
local howScroll=Instance.new("ScrollingFrame",howPage)
howScroll.Size=UDim2.new(1,-16,1,-144) howScroll.Position=UDim2.new(0,8,0,88)
...
hlEN.MouseButton1Click:Connect(function() lang="ENG" refreshHow() end)
hlTH.MouseButton1Click:Connect(function() lang="TH"  refreshHow() end)
hlVN.MouseButton1Click:Connect(function() lang="VN"  refreshHow() end)
...
inputPage.Active=true inputPage.Draggable=true inputPage.Visible=false
...
local vipBox=mkBox(inputPage,14,208,FW-28,30,"")
vipBox.Visible=false

-- vip toggle buttons
local vipSkipBtn=mkBtn(inputPage,"",14,210,math.floor((FW-36)/2),34,RED)
local vipWantBtn=mkBtn(inputPage,"",math.floor((FW-36)/2)+22,210,math.floor((FW-36)/2),34,BLUE)
