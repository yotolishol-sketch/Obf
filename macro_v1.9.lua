...
editBtn.Size=UDim2.new(0,48,0,48) editBtn.Position=UDim2.new(1,-56,0,34)
editBtn.BackgroundColor3=Color3.fromRGB(40,80,200) editBtn.Text="⚙️"
...
local macroStarted = false

selBack.MouseButton1Click:Connect(function()
    if macroStarted then return end
    fadeOut(selectPage,function() blurOut() fadeIn(inputPage) end)
end)

selOk.MouseButton1Click:Connect(function()
    macroStarted = true
    selBack.BackgroundColor3 = RED
    selBack.Text = "🔒 "..(TEXT[lang] and TEXT[lang].back or "< Back")
